...
def schedule_vendor_prep_meeting_manual(
    ...
    in place."""
    logger.info("VENDOR-PREP: manual meeting — cycleId=%s", cycleId)
    ...
    logger.info("VENDOR-PREP: manual meeting scheduled — event_id=%s, attendees=%d", event_id, len(invite_emails))
    return {
