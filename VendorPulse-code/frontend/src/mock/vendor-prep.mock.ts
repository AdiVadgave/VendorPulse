...
export const MOCK_VENDOR_BRIEF: VendorBrief = {
  ...
  category_ratings: [
    ...
    },
    {
      ...
      score: 3.83,
      rationale: 'Q1 pricing increase of 8% was flagged by Zensar Commercial Lead as needing stronger justification against agreed rate card.',
      trend: 'up',
    },
  ],
  key_concerns: [
  ...
  pb1: [
    {
      ...
      pushback_id: 'pb1',
      stance: 'factual',
      content: 'Zensar\'s incident log confirms the network outage occurred at 14:32 and vendor was notified at 14:35. Per SLA Appendix B, Section 3.1, the response clock starts at time of notification regardless of root cause. We will share the full incident timeline for review.',
      is_selected: false,
    },
    {
      response_id: 'pr1b',
    ...
    },
    {
      ...
      pushback_id: 'pb1',
      stance: 'escalation',
      content: 'Zensar\'s incident records are authoritative and were shared at the time of closure. If NovaTech believes there is a data error, the formal dispute process in the SLA agreement (Section 9.2) should be followed within 10 business days of the incident close date.',
      is_selected: false,
    },
  ],
  pb2: [
    {
      ...
      pushback_id: 'pb2',
      stance: 'factual',
      content: 'Zensar has no record of a formal verbal agreement in Q3 2025 authorising expanded AI pilot scope. The contractual SOW dated 2025-07-01 defines the scope. Any scope changes require a formal Change Request as per Section 5.3 of the MSA.',
      is_selected: false,
    },
    {
      response_id: 'pr2b',
    ...
    },
    {
      ...
      pushback_id: 'pb2',
      stance: 'escalation',
      content: 'This item involves contractual interpretation and has been flagged for Zensar Legal review. NovaTech should submit a formal written claim referencing the specific interaction date and participants. Zensar will respond within the contractual dispute window.',
      is_selected: false,
    },
  ],
  pb3: [
    {
      ...
      pushback_id: 'pb3',
      stance: 'factual',
      content: 'Zensar acknowledges Section 7.4 of the MSA contains a CPI indexation clause. However, the 8% increase exceeds the CPI index cap of 5% stipulated in Clause 7.4(b). The excess 3% requires separate commercial justification.',
      is_selected: false,
    },
    {
      response_id: 'pr3b',
    ...
    },
    {
      ...
      pushback_id: 'pb3',
      stance: 'escalation',
      content: 'The 8% figure exceeds the contractual CPI cap and will not be accepted without full justification. Zensar Commercial Lead has been notified. Any invoices at the increased rate will be held pending resolution of this commercial dispute.',
      is_selected: false,
    },
  ],
}
