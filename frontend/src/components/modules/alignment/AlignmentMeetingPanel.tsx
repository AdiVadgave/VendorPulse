 ...
 */
export default function AlignmentMeetingPanel({ cycleId, index, vendorName, period, onActionsExtracted, alreadyExtracted, qbrMeetingDate, qbrTimeZone, onScheduled }: Props) {
