...
export const MOCK_MEETING_NOTES: MeetingNote[] = [
  ...
  },
  {
    ...
    meeting_id: 'm1',
    note_type: 'OBJECTION',
    content: 'NovaTech disputes the SLA scoring for the February incident — claims Zensar network outage was root cause.',
    raised_by: 'Raj Patel',
    timestamp: '10:12',
  },
  {
  ...
  },
  {
    ...
    content: 'Zensar recognises NovaTech\'s proactive delivery improvement this quarter — Delivery Quality score up from Q4.',
    raised_by: 'Sarah Chen',
    timestamp: '10:28',
  },
  {
  ...
  },
  {
    ...
    meeting_id: 'm1',
    note_type: 'ACTION',
    content: 'NovaTech to submit written scope proposal for AI pilot Phase 2 by 15 April 2026. Zensar Legal to review.',
    raised_by: 'Alex Thompson',
    timestamp: '10:45',
  },
  {
    ...
    meeting_id: 'm1',
    note_type: 'DECISION',
    content: 'Pricing dispute to be escalated to Zensar Commercial team. Invoices at 8% increase rate held pending resolution.',
    raised_by: 'Emma Davies',
    timestamp: '10:52',
  },
  {
...
export const MOCK_MEETING_MINUTES: MeetingMinutes = {
  ...
  attendees: [
    'Alex Thompson (Zensar VMO)',
    'Sarah Chen (Zensar IDT)',
    'Priya Sharma (Zensar IDT)',
    'Tom Baker (Zensar VMO)',
    "James O'Brien (Zensar IDT)",
    'Emma Davies (Zensar VMO)',
    'Raj Patel (NovaTech)',
    'Lisa Wang (NovaTech)',
  ],
  executive_summary:
    'The Q1 2026 EGB/QBR for NovaTech Services concluded with an overall positive trajectory, scoring 3.8 against a 5-point scale. Key discussions centred on a disputed SLA incident in February, an AI automation pilot scope clarification, and a pricing increase query. Three action items were agreed and one commercial item escalated to Zensar Legal.',
  agenda_summaries: [
    {
    ...
    },
    {
      ...
      summary: 'February incident SLA breach disputed by NovaTech on grounds of Zensar network outage as root cause. Joint incident review agreed within 7 days to determine SLA applicability.',
    },
    {
      topic: 'AI Automation Pilot Scope',
      summary: 'NovaTech raised verbal agreement from Q3 2025 for expanded AI pilot scope. Zensar confirmed no formal record of agreement. Formal written proposal required for contractual processing.',
    },
    {
      topic: 'Pricing Review',
      summary: '8% pricing increase disputed as exceeding contractual CPI cap of 5%. Escalated to Zensar Commercial team. Invoices held pending resolution.',
    },
  ],
  key_decisions: [
    'Joint SLA incident review to be scheduled within 7 days',
    'Pricing dispute escalated to Zensar Commercial Lead — invoices at 8% increase held',
  ...
  action_items: [
    ...
    {
      description: 'Submit written AI pilot Phase 2 scope proposal for Zensar Legal review',
      owner: 'Lisa Wang (NovaTech)',
      due_date: '2026-04-15',
    },
    {
      description: 'Review pricing CPI clause and index source with Zensar Commercial Lead',
      owner: 'Emma Davies',
      due_date: '2026-04-07',
    },
  ],
